...
<br>
<br>
If you wish to use a snapshot release of Lambda, change `mavenType` to `releases` and `lambdaVersion` to either `version-SNAPSHOT` to get the latest snapshot or \
