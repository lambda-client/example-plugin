...
<br>
<br>
If you wish to use a snapshot releases of Lambda, change `lambdaVersion` to either `version-SNAPSHOT` to get the latest snapshot 
(ex: `0.1.0+1.21.11-SNAPSHOT`) or a specific snapshot date (ex: `0.1.0+1.21.11-20260405.194419-31`).

For official releases, set `lambdaVersion` to the latest available version (ex: `0.1.0+1.21.11`).
